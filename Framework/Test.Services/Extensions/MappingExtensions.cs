...
using Test.Data;
using Test.Entities;
using Test.Services.Infrastructure.AutoMapper;
...
namespace Test.Services.Extensions
{
    ...
    public static class MappingExtensions
    {
        ...
        private static TDestination Map<TDestination>(this object source)
        {
            ...
            return ServiceMapperConfiguration.Mapper.Map<TDestination>(source);
        }
        ...
        {
            //use AutoMapper for mapping objects
            return ServiceMapperConfiguration.Mapper.Map(source, destination);
        }
        ...
        public static TModel ToModel<TModel>(this EntityBase entity) where TModel : EntityBaseModel
        {
            if (entity == null)
        ...
        public static TEntity ToEntity<TEntity>(this EntityBaseModel model) where TEntity : EntityBase
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
